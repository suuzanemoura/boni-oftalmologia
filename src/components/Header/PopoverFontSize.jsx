...
export default function PopoverFontSize({ position, iconSize }) {
        ...
        >
          <div className="p-2 sm:p-4">
            {sizesVariation.map((item) => (
              <div
                key={item.name}
                className="group relative flex items-center gap-x-6 rounded-lg  p-4  text-sm leading-4 hover:bg-gray-50 cursor-pointer"
