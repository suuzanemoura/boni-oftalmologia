...
export default function PopoverNavBar({ products, callsToAction }) {
  return (
    <Popover.Group className="hidden lg:flex lg:gap-x-8 xl:gap-x-12">
      ...
      <Popover className="relative">
        <Popover.Button className="flex items-center gap-x-1 text-base font-medium leading-6 focus:outline-none">
          Contatos
          <ChevronDownIcon
