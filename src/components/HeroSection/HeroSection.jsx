    ...
    <section className="flex flex-col items-center w-full">
      ...
      <div className="w-full overflow-hidden leading-[0] -z-[100] mt-[-11rem] 2xs:mt-[-15rem] lg:mt-[-5rem]">
        <svg
          ...
          className="relative block w-[calc(275%+1.3px)] h-[18.5rem] 2xs:h-[25.5rem] md:w-[calc(267%+1.3px)] xs:h-[27.25rem] lg:w-[calc(138%+1.3px)] lg:h-[22rem] 3xl:h-[22.5rem] fill-white -z-50"
        >
